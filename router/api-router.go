	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/quota_request", controller.RequestUserQuota)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/quota_requests", controller.ListUserQuotaRequests)
				adminRoute.POST("/quota_requests/:request_id/approve", controller.ApproveUserQuotaRequest)
				adminRoute.POST("/quota_requests/:request_id/reject", controller.RejectUserQuotaRequest)
		...
		performanceRoute.Use(middleware.RootAuth())
		{
			...
			performanceRoute.GET("/system-tasks/list", controller.ListSystemTasks)
		...
		channelRoute.Use(middleware.AdminAuth())
		{
			...
			channelRoute.GET("/scheduler/runtime", controller.GetChannelSchedulerRuntimeStats)
			channelRoute.GET("/:id", controller.GetChannel)
			channelRoute.POST("/:id/key", middleware.RootAuth(), middleware.CriticalRateLimit(), middleware.DisableCache(), middleware.SecureVerificationRequired(), controller.GetChannelKey)
			channelRoute.GET("/test", controller.TestAllChannels)
			channelRoute.GET("/test/:id", controller.TestChannel)
			channelRoute.GET("/capability-test/:id", controller.TestChannelCapability)
		...
		groupRoute.Use(middleware.AdminAuth())
		{
			...
			groupRoute.GET("/user_identity", controller.GetUserIdentityGroups)
		}
