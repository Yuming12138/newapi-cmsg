...
func testChannel(channel *model.Channel, testUserID int, testModel string, endpointType string, isStream bool) testResult {
	...
	case relayconstant.RelayModeResponsesCompact:
		...
		case *dto.OpenAIResponsesCompactionRequest:
			convertedRequest, err = adaptor.ConvertOpenAIResponsesRequest(c, info, *req.ToResponsesRequest())
...
func testChannels(channels []*model.Channel, notify bool, allowDisable bool) error {
...
func testAllChannels(notify bool) error {
	...
	return testChannels(selectChannelsForAutomaticTest(channels, operation_setting.ChannelTestModeScheduledAll), notify, true)
}
...
func testAutoDisabledChannels(notify bool) error {
	...
	return testChannels(selectChannelsForAutomaticTest(channels, operation_setting.ChannelTestModePassiveRecovery), notify, false)
}
