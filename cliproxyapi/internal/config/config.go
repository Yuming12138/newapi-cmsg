...
type PluginsConfig struct {
	...
	// StoreAuth contains optional auth rules for private plugin store registries and artifacts.
...
func LoadConfigOptional(configFile string, optional bool) (*Config, error) {
	...
	cfg.Streaming.BootstrapRetries = DefaultStreamingBootstrapRetries
	...
	if errValidate := ValidateCredentialConcurrency(cfg.CredentialConcurrency); errValidate != nil {
