...
func (c ChannelInfo) Value() (driver.Value, error) {
	...
	// PostgreSQL's simple protocol encodes []byte parameters as bytea (\\x...),
	// which a JSON column rejects. A JSON string is portable across PostgreSQL,
	// MySQL, and SQLite while preserving the exact serialized document.
