...
const (
	...
	ErrorCodeChannelDailyProtectedBudgetExhausted ErrorCode = "channel_daily_protected_budget_exhausted"
	ErrorCodeChannelProtectedReserveReached       ErrorCode = "channel_protected_reserve_reached"
