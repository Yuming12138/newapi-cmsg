...
import { CapabilityTestDialog } from './dialogs/capability-test-dialog'
...
import { RoutingRuntimeDialog } from './dialogs/routing-runtime-dialog'
...
export function ChannelsDialogs() {
  ...
  return (
    <>
      ...
      {/* Routing Runtime Dialog */}
      <RoutingRuntimeDialog
        open={open === 'routing-runtime'}
        onOpenChange={(v) => !v && setOpen(null)}
      />
