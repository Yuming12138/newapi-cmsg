...
const CHANNEL_TYPE_DISPLAY_ORDER: number[] = [
  ...
  58, 59, 18, 45, 31, 35, 49, 19, 47, 37, 38, 39, 11, 8, 57, 22, 21, 44, 2, 5,
...
export const TYPE_TO_KEY_PROMPT: Record<number, string> = {
  ...
  58: 'MiMo API Key; default base URL uses Xiaomi Token Plan OpenAI-compatible endpoint',
  59: 'Used by route auth templates; can be referenced as {api_key}',
}
