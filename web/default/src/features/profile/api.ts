...
/**
 * Request a low-balance quota increase.
 */
export async function requestQuotaIncrease(): Promise<
  ApiResponse<UserQuotaRequestStatus>
> {
  const res = await api.post('/api/user/quota_request')
  return res.data
}
