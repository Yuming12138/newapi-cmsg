...
export interface UserQuotaRequestStatus {
  enabled: boolean
  can_request: boolean
  reason?: string
  date: string
  ...
  request_amount_usd: number
  request_amount_quota: number
  max_requests_per_day: number
  auto_approve_limit: number
  request_count: number
  remaining_requests: number
  latest_request?: QuotaRequestRecord
...
export interface UserProfile {
  ...
  /** LinuxDO ID (OAuth) */
  linux_do_id?: string
  /** Low-balance quota request status */
  quota_request?: UserQuotaRequestStatus
}
