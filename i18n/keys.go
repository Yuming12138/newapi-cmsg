...
const (
	...
	MsgDistributorDailyProtectedBudgetExhausted = "distributor.daily_protected_budget_exhausted"
	MsgDistributorProtectedReserveReached       = "distributor.protected_reserve_reached"
